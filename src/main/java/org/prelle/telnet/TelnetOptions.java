...
import org.prelle.telnet.mud.MUDEndOfRecord;
...
public enum TelnetOptions {
	...
	TRANSMIT_BINARY( 0, new TransmitBinary()),
	...
	MTT        (24, new MUDTerminalTypeStandard(24, "MTTS")),
	EOR        (25, new MUDEndOfRecord()),
	...
	TelnetOptions(int code, TelnetOptionHandler handler) {
		this.code = code;
	 ...
	 * @return
	 */
	static TelnetOptions valueOf(int optionCode) {
		for (TelnetOptions tmp : TelnetOptions.values()) {
